...
#Recibir comandos
   ...
   if opcion == "3":
      ...
      GPIO.output(22, GPIO.LOW)
      time.sleep(20) #se movio 10 segundos
      GPIO.output(18, GPIO.HIGH)
      GPIO.output(17, GPIO.LOW)
      GPIO.output(27, GPIO.LOW)
      GPIO.output(22, GPIO.LOW)
      time.sleep(4) #dio vuelta durante 5 segundos
      GPIO.output(18, GPIO.HIGH)
      GPIO.output(17, GPIO.LOW)
      GPIO.output(27, GPIO.HIGH)
      GPIO.output(22, GPIO.LOW)
      time.sleep(5); #avance 5 seg
      GPIO.output(18, GPIO.LOW)
      GPIO.output(17, GPIO.LOW)
      GPIO.output(27, GPIO.LOW)
      GPIO.output(22, GPIO.LOW)
      time.sleep(30); #stand by 30 seg
      GPIO.output(18, GPIO.HIGH)
      GPIO.output(17, GPIO.LOW)
      GPIO.output(27, GPIO.LOW)
      GPIO.output(22, GPIO.LOW)
      time.sleep(8); #vuelta de 180
      GPIO.output(18, GPIO.HIGH)
      GPIO.output(17, GPIO.LOW)
      GPIO.output(27, GPIO.HIGH)
      GPIO.output(22, GPIO.LOW)
      ...
      GPIO.output(27, GPIO.LOW)
      GPIO.output(22, GPIO.LOW)
      print("robotzin a llegado al sector A")
      continue
   if opcion == "4":
      #ruta hacia sector B
